...
import { createCategoryPath, loginPath } from "@/constants/route";
        ...
        <div className="flex items-center justify-between rounded-2xl border border-black/10 bg-gradient-to-r from-sky-100 via-white to-yellow-100 px-4 py-3 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            {session ? (
              ...
              <Link href={createCategoryPath} className="hidden sm:block">
            ...
            <Sheet open={open} onOpenChange={setOpen}>
              ...
              <SheetContent side="right" className="w-[300px] bg-white">
                ...
                <div className="mt-6 rounded-xl border border-black/10 bg-gradient-to-r from-yellow-200 to-sky-200 p-4">
                  <Link href={createCategoryPath} onClick={() => setOpen(false)}>
                    <Button className="bg-gradient-to-r from-sky-500 to-yellow-400 text-black hover:opacity-90">
                      <Plus className="mr-2 h-4 w-4" />
                      Add Category
                    </Button>
