...
const CategoriesList = ({ category }: CategoriesProp) => {
  return (
    <Card className="group relative overflow-hidden rounded-3xl border border-sky-100 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-sky-300 hover:shadow-2xl">
      {/* Top Gradient Accent */}
      <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-sky-400 via-sky-300 to-yellow-300" />

      <CardContent className="p-5">
        {/* Header */}
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-3">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-sky-400 to-yellow-300 shadow-md transition-transform duration-300 group-hover:scale-105">
        ...
        <div className="mt-5 rounded-2xl bg-gradient-to-r from-sky-500 to-yellow-400 p-4 text-black">
