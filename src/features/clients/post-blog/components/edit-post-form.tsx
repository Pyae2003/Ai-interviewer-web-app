...
import { editPostSchema, type EditPostInput } from "../schema/edit-post.schema";
...
export function EditPostForm({ post }: EditPostFormProps) {
  ...
  const initialValues = useMemo<EditPostInput>(
    () => ({
      postId: post.id,
      caption: post.caption,
      images: post.images,
    }),
    [post.id, post.caption, post.images],
  );
  ...
  useEffect(() => {
    if (hasSucceeded) {
      toast.success(result.data?.message ?? "Post updated successfully!");
        ...
        <div className="relative mx-auto w-full max-w-2xl">
          ...
          <header className="mb-8 text-center">
            ...
            <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-600 dark:text-slate-400">
              Update your caption or change the images in your community post.
            </p>
          </header>
          ...
          <Card className="overflow-hidden border border-sky-100/80 bg-white/90 py-0 shadow-xl shadow-sky-100/60 backdrop-blur-xl dark:border-sky-900/60 dark:bg-slate-900/90 dark:shadow-black/30">
            ...
            <CardHeader className="border-b border-sky-100 bg-sky-50/60 px-6 py-6 dark:border-sky-900/60 dark:bg-sky-950/20 md:px-8">
              ...
              <CardDescription className="text-slate-600 dark:text-slate-400">
                Update your caption and up to four images.
              </CardDescription>
            </CardHeader>
              ...
              >
                ...
                <div className="flex flex-col gap-3 pt-2 sm:flex-row">
                  <Button
                    type="submit"
                    disabled={
                      isLoading || !form.formState.isValid || isUnchanged
                    }
            ...
            <CardFooter className="flex flex-col gap-3 border-t border-sky-100 bg-sky-50/60 px-6 py-5 dark:border-sky-900/60 dark:bg-sky-950/20">
              <p className="text-center text-xs leading-5 text-slate-500 dark:text-slate-400">
                Changes will be visible to other community members after saving.
              </p>
